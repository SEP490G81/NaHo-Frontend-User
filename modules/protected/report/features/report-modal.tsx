...
export function ReportModal() {
  ...
  return (
    ...
    >
      ...
      >
        <span className="text-text-contrast font-bold text-lg">
          {t("modalTitle")}
        </span>
      ...
      <form onSubmit={handleSubmit}>
        <DialogContent sx={{ py: 3 }} className="space-y-4">
          <div className="flex items-center gap-2 mb-2">
            ...
            <span className="bg-bgc-highlight/15 text-bgc-highlight text-xs font-bold px-3 py-1 rounded-full border border-bgc-highlight/25">
