    ...
    <div className="flex gap-3">
      ...
      <div className="max-w-[80%] space-y-2">
        <div className="flex items-center gap-2 text-xs text-text-muted">
          <span className="font-medium text-text-contrast">{companion.name}</span>
          <span>{message.timestamp}</span>
        </div>
        <div className="rounded-2xl rounded-tl-sm border border-bdc-primary bg-bgc-app px-4 py-3 shadow-sm">
          ...
          {showAudio && (
            <div className="mt-3">
              <MockAudioPlayer durationSec={6} autoPlay={message.autoPlay} />
            </div>
          )}
        </div>
        ...
        <div className="flex flex-wrap gap-2">
          <Button
            ...
            className="!rounded-full border border-bdc-primary !text-text-contrast hover:!border-bgc-highlight hover:!bg-bgc-highlight/10 !text-xs capitalize"
        ...
        {showTranslation && (
          <div className="rounded-lg border border-bdc-primary bg-bgc-page px-3 py-2 text-sm">
        ...
        {showGrammar && (
          <div className="rounded-lg border border-sky-300/60 bg-sky-50 px-3 py-2 text-sm dark:border-sky-500/40 dark:bg-sky-500/10">
            <div className="mb-0.5 text-[11px] font-medium uppercase tracking-wide text-sky-700 dark:text-sky-300">
              {t("grammarHeader")}
            </div>
            {message.grammar}
          </div>
