...
export function LiveChatroom() {
  ...
  return (
    <div className="flex h-[calc(100vh-140px)] w-full overflow-hidden rounded-xl border border-bdc-primary bg-bgc-app shadow-sm">
      {/* Desktop sidebar */}
      ...
      <Drawer
        ...
        className="[&_.MuiDrawer-paper]:w-72 [&_.MuiDrawer-paper]:box-border [&_.MuiDrawer-paper]:bg-bgc-app [&_.MuiDrawer-paper]:border-r [&_.MuiDrawer-paper]:border-bdc-primary"
      >
        <ChatSidebar
          showFurigana={showFurigana}
          onToggleFurigana={setShowFurigana}
      ...
      {/* Main chat area */}
      <div className="flex min-w-0 flex-1 flex-col bg-bgc-page/20">
        {/* Mobile header */}
        <MobileHeader
          companion={companion}
        ...
        {/* Bottom controller */}
        <div className="border-t border-bdc-primary bg-bgc-app px-4 py-4 sm:px-6">
