...
const H_LESSON = 90; // Chiều cao ô Cờ Bài học 3D Graphic
const H_CANDO = 82; // Chiều cao ô Cờ Can-Do 3D Graphic
const H_NODE = 116; // Chiều cao ô node 3D (dọc gần nhau hơn)
