...
export function CommentItem({
    ...
    const userReaction = commentReactions.find(
                    ...
                    <div className="flex items-center gap-4 pl-2 text-xs select-none">
                        ...
                        >
                            <button
                                ...
                                className={`flex cursor-pointer items-center gap-1.5 transition-colors ${reactionBtnColor}`}
                            >
                        ...
                        <button
                            ...
                            className="text-text-muted flex cursor-pointer items-center gap-1 transition-colors hover:text-red-500"
                        >
