...
export function WelcomeBanner({ name, t }: WelcomeBannerProps) {
    return (
        <div className="flex flex-col gap-4 rounded-2xl border border-bdc-primary bg-bgc-app p-6 md:flex-row md:items-center md:justify-between">
            <div className="space-y-1">
                <h1 className="text-2xl font-bold md:text-3xl text-text-contrast">
                    {t("welcome", { name })}
                </h1>
