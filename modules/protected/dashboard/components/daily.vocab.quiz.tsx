...
const QUIZ_QUESTIONS: QuizQuestion[] = [
    {
        ...
        correctIndex: 0,
        explanation:
            "「遠慮なく」 (Enryo naku) nghĩa là 'Không cần ngại ngần', thường dùng khi mời người khác dùng bữa hoặc nhận giúp đỡ.",
    },
    {
        id: 2,
        word: "いただきます",
        ...
        context:
            "Câu nói nào bắt buộc dùng trước khi bắt đầu bữa ăn ở Nhật Bản?",
        options: [
            "ごちそうさまでした",
            "いただきます",
            "お邪魔します",
        ...
        correctIndex: 1,
        explanation:
            "「いただきます」 thể hiện lòng biết ơn chân thành đối với món ăn và người đã nấu bữa ăn.",
    },
    {
        id: 3,
        word: "相槌",
        ...
        context:
            "Khái niệm 「相槌」 cực kỳ quan trọng trong nghệ thuật giao tiếp Kaiwa là gì?",
        options: [
        ...
        correctIndex: 1,
        explanation:
            "Aizuchi (相槌) là nét văn hóa gật đầu và chêm câu 'はい', 'そうですね' liên tục để khích lệ người nói.",
    },
    {
        id: 4,
        word: "お疲れ様です",
        furigana: "おつかれさまです",
        context:
            "Cụm từ 「お疲れ様です」 thường được sử dụng trong trường hợp nào?",
        options: [
        ...
        correctIndex: 1,
        explanation:
            "「お疲れ様です」 dùng để ghi nhận sự nỗ lực làm việc vất vả của đồng nghiệp và bạn học.",
    },
];
            ...
            <div className="mt-5 space-y-4">
                ...
                {isAnswered && (
                    <div className="border-bdc-primary/40 mt-4 flex flex-col items-center justify-between gap-3 border-t pt-3 sm:flex-row">
                        <p
                            className={`text-xs font-semibold ${isCorrect ? "text-emerald-600 dark:text-emerald-400" : "text-rose-600 dark:text-rose-400"}`}
                        >
