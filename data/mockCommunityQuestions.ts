...
export const COMMUNITY_CATEGORIES: { value: CommunityCategory | "all"; label: string }[] = [
...
export const mockCommunityQuestions: CommunityQuestion[] = [
  ...
  },
  {
    ...
    furigana: "いままででいちばんむずかしかったプロジェクトをおしえてください。",
  ...
  },
  {
    ...
    furigana: "リリーススケジュールにおくれがでそうです。どうたいおうしますか？",
  ...
  },
  {
    ...
    furigana: "おきゃくさまへのしんちょくほうこくメールをこうとうでせつめいしてください。",
  ...
  },
  {
    ...
    furigana: "じょうしにきゅうかをしんせいするときのいいかたをおしえてください。",
