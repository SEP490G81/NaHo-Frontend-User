...
const ChestBronze: React.FC<ChestProps> = ({ size = 48, className = "", ...props }) => {
    return (
        <svg
            width={size}
            height={size}
        ...
        >
            <defs>
                ...
                {/* Bronze Lid Gradient */}
                <linearGradient id="bronzeLid" x1="0%" y1="0%" x2="0%" y2="100%">
                ...
                <filter id="shadowBronze" x="-20%" y="-20%" width="140%" height="140%">
                    <feDropShadow dx="0" dy="4" stdDeviation="2.5" floodColor="#78350f" floodOpacity="0.4" />
                </filter>
            </defs>

            {/* Chest Shadow / Base */}
            <ellipse cx="32" cy="54" rx="22" ry="5" fill="#451A03" opacity="0.3" />
            ...
            <path d="M22 28V52M42 28V52" stroke="#92400E" strokeWidth="1" opacity="0.6" />
            ...
            {/* Lid Rim / Metal Band */}
            <rect x="9" y="26" width="46" height="4" rx="2" fill="url(#metalTrim)" stroke="#78350F" strokeWidth="1" />

            {/* Horizontal & Corner Metal Brackets */}
            <rect x="12" y="32" width="6" height="18" fill="url(#metalTrim)" opacity="0.9" />
            <rect x="46" y="32" width="6" height="18" fill="url(#metalTrim)" opacity="0.9" />
            ...
            {/* Center Lock Frame */}
            <rect x="26" y="29" width="12" height="14" rx="2" fill="url(#goldLock)" stroke="#78350F" strokeWidth="1" />
            ...
            {/* Top Lid Highlight */}
            <path d="M16 18C20 15 28 14 36 15" stroke="#FEF3C7" strokeWidth="1.5" strokeLinecap="round" opacity="0.7" />
        </svg>
    );
};
