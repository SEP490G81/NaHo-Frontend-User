...
const SettingsLayout = ({ children }: { children: React.ReactNode }) => {
    return (
        <div className="bg-bgc-app/60 fixed top-0 left-0 z-20 flex h-screen w-full items-center justify-center p-4 md:p-6">
            <div className="border-bdc-primary bg-bgc-page relative rounded-2xl border flex flex-col h-[85vh] max-h-[850px] min-h-[600px] w-[92vw] max-w-[1300px] overflow-hidden shadow-2xl">
